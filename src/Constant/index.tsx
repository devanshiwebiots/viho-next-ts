...
export const UnOrderListConst = 'UnOrder list';
export const OrderListConst = 'Order list';
export const FontAwesomeListConst = 'FontAwesome list';
export const ICOIconListConst = 'ICO Icon list';
export const ThemFyListConst = 'ThemFy list';
...
//header
export const ImagePath = '/assets/images/logo';
export const AssetsImagePath = '/assets/images';
export const ErrorMessage = 'Ops!! There are no result found.';
export const Back = 'Back';
export const Notify = 'Notifications';
export const LogOutConst = 'Log Out';
...
export const ScrollingLongContent = 'ScrollingLongContent';
export const VerticallyCentered = 'VerticallyCentered';
export const TooltipsAndPopovers = 'TooltipsAndPopovers';
export const UsingTheGrid = 'UsingTheGrid';
export const SaveChanges = 'SaveChanges';
export const SizesModal = 'SizesModal';
export const LargeModal = 'LargeModal';
export const SmallModal = 'SmallModal';
export const VaryingModalContent = 'VaryingModalContent';
...
export const FollowersConst = 'Followers';
export const AddFriend = 'AddFriend';
export const FollowingsConst = 'FollowingsConst';
...
export const OutlineExtraSmallButtons = 'Emailutton group';
...
export const UserNameError = 'UserNameError';
...
export const StateError = 'StateError';
export const ZipError = 'ZipError';
export const TermsAndConditions = 'Terms And Conditions';
export const FirstNameRequire = 'FirstNameRequire';
export const CheckThisCheckbox = 'Check this custom checkbox';
export const InvalidFeedBack = 'Invalid FeedBack';
export const InvalidFile = 'InvalidFile';
export const ToggleThisRadio = 'ToggleThisRadio';
export const OrToggleThisRadio = 'OrToggleThisRadio';
export const MoreInvalidFeedBack = 'MoreInvalidFeedBack';
...
export const RecentTextHeading1 = 'Any desktop publishing packages and web page editors.';
export const RecentTextHeading2 = 'Contrary to popular belief, dashboard is not simply.';
export const RecentTextHeading3 = 'Established fact that a reader will be distracted';
export const RecentTextHeading4 = 'H-Code - A premium portfolio template from ThemeZaa';
...
export const ProductCart = 'PRODUCTS CART';
...
export const ContextualClasses = 'ContextualClasses';
...
export const AlertWithIcon = 'AlertWithIcon';
export const LightAlerts = 'LightAlerts';
export const LinkColor = 'LinkColor';
export const OutlineAlerts = 'OutlineAlerts';
export const OutlineDarkAlerts = 'OutlineDarkAlerts';
export const AlertWithIconInverse = 'AlertWithIconInverse';
export const TextAsAction = 'TextAsAction';
export const AdditionalContent = 'AdditionalContent';
export const YourTimeOverAfter = 'Your time Over after';
...
export const OffsetToTooltip = 'OffsetToTooltip';

//tooltip

export const BasicTooltip = 'BasicTooltip';
export const HoverMe = 'HoverMe';
export const PopoverTitle = 'PopoverTitle';
...
export const BasicDropdown = 'BasicDropdown';
export const DropdownButton = 'DropdownButton';
export const SomethingElseHere = 'SomethingElseHere';
export const BasicColorDropdown = 'BasicColorDropdown';
export const DropdownSplitButton = 'DropdownSplitButton';
export const RoundedDropdown = 'RoundedDropdown';
export const AnotherLink = 'AnotherLink';
export const DropdownWithDivider = 'DropdownWithDivider';
export const DropdownWithHeader = 'DropdownWithHeader';
export const DropdownHeader = 'DropdownHeader';
export const DropdownWithDropUp = 'DropdownWithDropUp';
export const DropdownWithDisable = 'DropdownWithDisable';
...
export const ColorAccordion = 'ColorAccordion';
export const AccordionWithIcon = 'Accordion With Icon On Title';
export const AccordionWithOperand = 'Accordion Open Close Icon';
...
export const LargerShadow = 'LargerShadow';
export const NoShadow = 'NoShadow';
export const RegularShadow = 'RegularShadow';
export const SmallShadow = 'SmallShadow';
...
export const ProductCap = 'PRODUCTS';
export const TotalEarning = 'Total Earning';
export const BrowserUsesConst = 'Browser Uses';
export const Turnover = 'Turnover';
export const MonthlySalesConst = 'Monthly Sales';
export const Uses = 'Uses';
export const LiveProducts = 'LiveProducts';
export const MonthlySales = 'MonthlySales';
export const AboutMe = 'About Me';
export const MarkJecno = 'Mark Jecno';
export const MyProfile = 'My Profile';
export const Save = 'Save';
export const AddprojectAndUpload = 'AddprojectAndUpload';
export const ProjectName = 'ProjectName';
export const Status = 'Status';
export const Href = 'Href';
export const UntrammelledPrevents = 'UntrammelledPreventsc';
...
export const BasicCalendars = 'BasicCalendars';
export const Dragging_Event = 'Draggable Calender';
export const DraggableEvents = 'Events';
...
export const STATUS = 'STATUS';
export const CallParagraph = 'CallParagraph';
export const CallParagraph2 = 'CallParagraph2';
...
export const LatestActivityConst = 'Latest Activity';
export const RecentOrdersConst = 'Recent Orders';
export const Name = 'Name';
export const QuantityConst = 'Quantity';
export const Value = 'Value';
export const Rate = 'Rate';
export const TotalBalance = 'Total Balance';
export const InvoiceOverview = 'Invoice Overview';
export const OurTarget = 'OurTarget';
export const WeArchieve = 'We Archieve';
export const UpdatedProduct = 'Updated Product';
export const Tomorrow = 'Tomorrow';
export const TodayTotalRevenue = 'Today Total Revenue';
export const TopDealer = 'TopDealer';
export const ViewMore = 'ViewMore';
export const TopSellingProduct = 'Top Selling Product';
export const TotalSelling = 'Total Selling';
export const YearlyGrowth = 'Yearly Growth';
//Project
...
export const TownCity = 'TownCity';
export const StateCountry = 'StateCountry';
...
export const ThemifyIcon = 'ThemifyIcon';
export const WeatherIcon = 'Weather Icon';
export const FilterHeading = 'Filter Heading';
export const LocationHeading = 'LocationHeading';
export const IndustryHeading = 'IndustryHeading';
export const FullTime = 'FullTime';
export const Parttime = 'Parttime';
export const Internship = 'Internship';
export const Temporary = 'Temporary';
export const Commission = 'Temporary';
export const Contract = 'Contract';
export const Nodejs = 'Nodejs';
export const GulpPug = 'GulpPug';
export const Angularjs = 'Angularjs';
export const FinancialServices = 'Financial Services';
export const Frontenddesigner = 'Frontend designer';
export const PHPdeveloper = '  PHPdeveloper';
export const ReactDeveloper = 'ReactDeveloper';
export const UIUxdesigner = 'UIUxdesigner';
export const htmlcss = 'htmlcss';

export const Savethisjob = ' Save this job';
export const ApplyForThisJob = 'Apply For This Job';
export const VihoUnitedStates = 'viho United States';
export const JobDescriptionHeading = 'JobDescriptionHeading';
export const JobDetaildec = 'JobDetaildec';
...
export const XoloEndless = 'XoloEndless';
...
export const EdgeButton = 'Edge Button';
export const FlatButton = 'FlatButton';
export const ButtonGroups = 'ButtonGroups';
...
export const DangerSelect = 'DangerSelect';
export const OneValue = 'OneValue';
export const OutlineColorVariant = 'Outline Color Variant';
export const Disable = 'Disable';
export const Enable = 'Enable';
export const EnableDisable = 'Enable Disable';
export const DefaultPlaceholder = 'Default Placeholder';
export const DisabledResults = 'Disabled Results';
export const HidingTheSearchBox = 'Hiding The SearchBox';
export const LimitingTheNumberOfSelections = 'Limiting The Number Of Selections';
...
export const clipBoardTextParagraph = 'clipBoard Text Paragraph';
export const ClipboardOnParagraph = 'ClipboardOnParagraph';
export const CopyFromParagraph = 'Copy From Paragraph';
export const CopyPortionFromParagraph = 'Copy Portion From Paragraph';
export const ClipBoardCopy = 'Clip Board Copy';
...
export const DynamicHeight = 'Dynamic Height';
...
export const EditBookmark = 'EditBookmark';
export const Group = 'Group';
export const WebUrl = 'WebUrl';
export const AddBookmarks = 'Add Bookmarks';
export const ContactHistory = 'Contact History';
export const PrintViews = 'Print Views';
export const SwitchSizingHeading = 'Switch Sizing Heading';
export const Confirmation = 'Confirmation';
export const FriendsConst = 'Friends Const';
export const LatestPhotosConst = 'Latest Photos Const';
export const AssetVideoPath = 'Asset Video Path';
export const WeAreComingSoon = 'We Are Coming Soon';
export const DaterangePicker = 'Daterange Picker';
