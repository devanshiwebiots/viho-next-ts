...
const FormatedLabelClass = () => {
  ...
  return (
    <Col sm='12'>
      <Card>
        <CardHeaderCommon title='Formated Label' />
        <CardBody>
                  ...
                  <Range
                    ...
                    renderTrack={({ props, children }) => (
                      <div onMouseDown={props.onMouseDown} onTouchStart={props.onTouchStart} style={{ ...props.style, height: '36px', display: 'flex', width: '100%' }}>
                        ...
                        <div ref={props.ref} style={{ height: '5px', width: '100%', borderRadius: '4px', background: getTrackBackground({ values: values4, colors: ['#26695c', '#ccc'], min: 0, max: 20 }), alignSelf: 'center' }}>
                          {children}
                        </div>
