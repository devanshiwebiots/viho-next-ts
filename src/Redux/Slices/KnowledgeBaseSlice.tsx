import { knowledgeBaseSliceType, knowledgeDataPropsType } from '@/Type/SideBarType';
import { knowledgeData } from '@/app/ApiData/knowledgeBase';
import { createAsyncThunk, createSlice } from '@reduxjs/toolkit';

export const fetchContent: any = createAsyncThunk<knowledgeDataPropsType[], void, {}>('fetch/knowledge', async () => {
