...
const BottomLeftAlignCard = () => {
  ...
  return (
    <Col sm='12' xl='6 xl-100'>
      <Card>
        <CardHeaderCommon title='Tabs Bottom Left Align' />
        <CardBody>
          <TabContent activeTab={BottomTab}>
            <TabPane className='fade show' tabId='1'>
              <p className='mb-0 m-b-30'>1{loremConstant}</p>
            </TabPane>
            <TabPane tabId='2'>
              <p className='mb-0 m-b-30'>2{loremConstant}</p>
            </TabPane>
            <TabPane tabId='3'>
              <p className='mb-0 m-b-30'>3{loremConstant}</p>
            </TabPane>
          </TabContent>
          <Nav className='nav-tabs nav-bottom'>
            <NavItem>
