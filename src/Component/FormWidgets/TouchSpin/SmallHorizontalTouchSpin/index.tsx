...
import { SmallHorizontalTouchspinSubHeading } from '@/Data/CardHeaderCommonData';
...
const SmallHorizontalTouchspin = () => {
  ...
  return (
    <Col sm='12' md='6'>
      <Card>
        <CardHeaderCommon title='Small Horizontal Touchspin' description={SmallHorizontalTouchspinSubHeading} />
        <CardBody>
