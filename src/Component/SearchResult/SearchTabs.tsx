import { SearchTabType } from '@/Type/SideBarType';
import React, { Fragment, useState } from 'react';
import { Image, Map, Settings, Target, VideoOff } from 'react-feather';
import { Nav, NavLink, NavItem } from 'reactstrap';

const SearchTabs = ({ callbackActive }: SearchTabType) => {
      ...
      <Nav tabs className='search-list' id='top-tab' role='tablist'>
        ...
        <NavItem>
          <NavLink
            ...
            <VideoOff className='icon-video-clapper' />
            &nbsp;Videos
          </NavLink>
          <div className='material-border'></div>
        </NavItem>
