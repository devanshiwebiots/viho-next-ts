...
const PillInfoTab = () => {
  ...
  return (
    <Col sm='12' xl='6 xl-100'>
      <Card>
        <CardHeaderCommon title={'Info Color'} />
        <CardBody>
          <Nav className='nav-info' tabs>
            <NavItem>
          ...
          <TabContent activeTab={infoTab}>
            <TabPane tabId='1'>
              <p className='mb-0 m-t-30'>1{loremConst}</p>
            </TabPane>
            <TabPane tabId='2'>
              <p className='mb-0 m-t-30'>2{loremConst}</p>
            </TabPane>
            <TabPane tabId='3'>
              <p className='mb-0 m-t-30'>3{loremConst}</p>
            </TabPane>
          </TabContent>
        </CardBody>
      </Card>
