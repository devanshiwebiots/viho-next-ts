...
const primary = '#26695c';
const secondary = '#c29873';

export const SaleChart: any = {
  series: [
    {
      name: 'series1',
...
export const TotalEarningChart: any = {
  series: [70],
  options: {
    chart: {
      height: 350,
  ...
  plotOptions: {
      radialBar: {
          hollow: {
              margin: 15,
              size: '70%',
              image: `${`${AssetsImagePath}/email-template/success.png`}`,
              imageWidth: 64,
              imageHeight: 64,
              imageClipped: false
          },
  ...
  fill: {
      type: 'image',
      image: {
          src: [`${`${AssetsImagePath}/user-card/5.jpg`}`],
      }
  },
  stroke: {
      lineCap: 'round'
...
export const WidgetsUserChart: any = {
  options: {
    chart: {
      toolbar: {
        show: false,
