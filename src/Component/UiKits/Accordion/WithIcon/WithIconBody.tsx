import { AccordionWithIcon } from '@/Constant';
import { WithIconBodyType } from '@/Type/SideBarType';
import React from 'react';
import { Button, CardBody, CardHeader, Collapse } from 'reactstrap';

const WithIconBody = ({ isOpen, element, toggle }: WithIconBodyType) => {
  return (
    <>
      <CardHeader>
        <h5 className='mb-0'>
