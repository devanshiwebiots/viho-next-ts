...
import { ButtonClassToLinkSubHeading } from "@/Data/CardHeaderCommonData";
...
const ButtonClassToLink = () => {
  ...
  return (
    <Col sm="12" md="6">
      <Card>
        <CardHeaderCommon title="Change Button Class To Link" description={ButtonClassToLinkSubHeading} />
        <CardBody>
