...
const SideBarProfile = () => {
  ...
  return (
    <div className='sidebar-user text-center'>
      ...
      <Image height={90} width={90}  priority className='img-90 rounded-circle' alt='Profile Image' src={session?.user?.image || `${AssetsImagePath}/dashboard/1.png`} unoptimized/>
