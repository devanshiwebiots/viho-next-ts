...
const NegativeValuesClass = () => {
  ...
  return (
    <Col sm='12' xl='6'>
      <Card>
        <CardHeaderCommon title='Negative Values' />
        <CardBody>
                  ...
                  <Range
                    ...
                    renderTrack={({ props, children }) => (
                      <div onMouseDown={props.onMouseDown} onTouchStart={props.onTouchStart} style={{ ...props.style, height: '36px', display: 'flex', width: '100%' }}>
                        ...
                        <div ref={props.ref} style={{ height: '5px', width: '100%', borderRadius: '4px', alignSelf: 'center', background: getTrackBackground({ values: values2, colors: ['#26695c', '#ccc'], min: -20, max: -0 }) }}>
                          {children}
                        </div>
