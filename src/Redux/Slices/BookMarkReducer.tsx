...
export const { setIsClose, setBookMarkClass, updateFillStar, fillStarFalse, updateFavFilStar, addData, addNewBookmark, updateActiveTabss, setGridView, removeBookmMark, removeMyBookMark, setEditImgUrl, setEditRow, setEditModal, updateBookMark } = BookMarkSlice.actions;
