import { AllCloseAccordion } from '@/Constant';
import { AllCloseBodyType } from '@/Type/SideBarType';
import React from 'react';
import { Button, CardBody, CardHeader, Collapse } from 'reactstrap';

const AllCloseBody = ({ isOpen, element, toggle }: AllCloseBodyType) => {
  return (
    <>
      <CardHeader>
        <h5 className='mb-0'>
